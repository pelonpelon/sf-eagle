...
<html>
  ...
  <body><!-- hello -->
    <!-- #background-->
    <div id="root">
      <div id="page" class="simple bearweekend"><a href="index.php"><img src="images/logo.svg" alt="logo" class="logo"></a>
        <div class="content">
          <header><span class="bigtype">SF&nbsp;Bear&nbsp;Weekend&nbsp;(2.0)</span></header>
    ...
    if (has_post_thumbnail( $post_id )) {
      ...
      <div class="thumb">
        <a href="<?php echo $image_large[0] ?>" rel="lightbox">
          ...
          <section class="intro">
            <div class="thumb"><a href="http:/www.sfbearweekend.com"><img src="images/events/sfbw_paw.jpg" alt="bearpaw" class="flyer"></a></div>
            <article>
              <p>All truly amazing things must come to an end.<a href="http://en.wikipedia.org/wiki/Bear_Magazine"> BEAR</a> -- The zine that started it all. Pre-earthquake<a href="http://en.wikipedia.org/wiki/Rick_Redewill"> Lone&nbsp;Star&nbsp;Saloon</a> -- The bar that first recognized that hairy men are beautiful. Harrison Street Fair -- Those first two years were unforgettable. And
              ...
              <p>
                ...
                have planned a few events this weekend. You'll find even more choices over at<a href="http://www.sfbearweekend.com"> SFBearWeekend.com</a> including information on where to stay and where to meet the fur ball of your dreams.
              </p>
