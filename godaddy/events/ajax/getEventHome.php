...
<div class="event_nav_buttons_container">
	...
	<div class="event_link"><a class="preview_event_button back_list_button" href="#" onclick="javascript:getEventsHomeList(<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $pag; ?>,'<?php echo $_GET["filter"]; ?>');"><?php echo $lang["GETEVENT_BACK_TO_EVENTS_LIST"]; ?></a></div>
    <!-- close -->
    <div class="font_custom close_booking"><a href="#" onclick="javascript:closeHomeEvents(<?php echo $_GET["year"]; ?>,<?php echo $_GET["month"]; ?>,<?php echo $calendarObj->getCalendarId(); ?>);"><?php echo $lang["GETEVENT_CLOSE"]; ?>&nbsp; X</a></div>
</div>
...
<div class="events_container">
    ...
    <div class="title_share_container">
        <!-- event title -->
       <?php
	   $arrDateFrom = explode('-',$eventObj->getEventDateFrom());
	   ?>
        <div class="font_custom events_title_inside"><?php echo $arrDateFrom[2]."&nbsp;".$weekdays[intval(date('w',mktime(0,0,0,$arrDateFrom[1],$arrDateFrom[2],$arrDateFrom[0])))]; ?>&nbsp;-&nbsp;<span style="color:#567BD2;"><?php echo $eventObj->getEventTitle(); ?></span></div>
        ...
        <div class="event_rightside">
        	...
        	<div class="event_buttons_container">
				...
				if($eventObj->getEventDescription()!='') {
					?>
                    <!-- description -->
                    <div class="event_link"><a class="preview_event_button readmore_button" style="background-position:-260px -290px" id="text_button" href="javascript:closeContent();"><?php echo $lang["GETEVENT_DESCRIPTION"]; ?></a></div>
                    <?php
				}
				?>
                <?php
            ...
            <div class="event_content_container">
                ...
                <div class=" event_text" id="text_container">            	
