...
<div class="event_nav_buttons_container">
	...
	<div class="event_link"><a class="preview_event_button back_list_button" href="#" onclick="javascript:searchEventsList('<?php echo $searchText; ?>',<?php echo $calendarObj->getCalendarId(); ?>,<?php echo $pag; ?>);"><?php echo $lang["GETEVENT_BACK_TO_EVENTS_LIST"]; ?></a></div>
    <!-- close -->
        	...
        	<div class="event_info_box">
                ...
                if(count($arrayCustomTimes)>0) {
                    ...
                    <div class="event_info_row">
						...
						echo " ".$lang["GETEVENT_START_TIME"]; ?></div>
                    <?php
					} else {
						?>
