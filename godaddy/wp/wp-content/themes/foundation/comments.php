...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="navigation-comment" role="navigation">
			<h1 class="screen-reader-text"><?php _e( 'Comment navigation', 'foundation' ); ?></h1>
		...
		<ol class="comment-list">
			<?php
				 ...
				 * to use foundation_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define foundation_comment() and that will be used instead.
				 * See foundation_comment() in inc/template-tags.php for more.
				 */
				wp_list_comments( array( 'callback' => 'foundation_comment' ) );
			?>
		</ol><!-- .comment-list -->
