...
ga('send', 'pageview');</script></head><body><!-- hello --><div id="page"><a href="index.php"><img src="images/logo-transparency-whiteeagle-cutout-thumb.png" alt="logo"></a></div></body></html>